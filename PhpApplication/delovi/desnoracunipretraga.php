...
<td align="center">
<b><font face="Trebuchet MS" color="darkblue" size="3px">PRETRAGA RACUNA</font></b></br>
</td>
<td style="width:3%;">
</td>
</tr>
...
<form ACTION="RacuniPretragaRezultati.php" METHOD="POST" enctype="multipart/form-data">


<tr>
<td align="right" valign="top">
<b><font face="Trebuchet MS" color="darkblue" size="2px">Je plaćen/nije plaćen (1/0):&nbsp;&nbsp;</font><br/></b>
</td>
<td align="left" valign="top">
<select name="jePlacen" required TABINDEX=8 width="250" style="width: 250px">		
	<!--<option value="izaberite">izaberite...</option>-->
	<?php
	if ($num_rowsplaceni>0) {
							for ($rowplaceni = 0; $rowplaceni < $num_rowsplaceni; $rowplaceni++) {
								if ($rowplaceni > $num_rowsplaceni){
										// nista
									} else {
										$JePlacen=mysql_result($resultplaceni,$rowplaceni,"jePlacen");
										echo "<option value=\"$JePlacen\">$JePlacen</option>";
										} // if row
							} //for
