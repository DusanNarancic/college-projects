						...
						if ($db_selected)
										   {
											...
											//$SQL = "select distinct DatumPrispeca from `".$bazapodataka."`.`Racun` ORDER BY DatumPrispeca ASC";
											$SQL = "SELECT `".$bazapodataka."`.`Usluga`.IdUsluge,`".$bazapodataka."`.`Usluga`.IdKorisnika,`".$bazapodataka."`.`Racun`.DatumPrispeca FROM `".$bazapodataka."`.`Racun` INNER JOIN `".$bazapodataka."`.`Usluga` ON `".$bazapodataka."`.`Racun`.IdUsluge=`".$bazapodataka."`.`Usluga`.IdUsluge WHERE `".$bazapodataka."`.`Usluga`.IdKorisnika='".$idkorisnika."'";
...
<?php include 'delovi/desnoracunipretragadatumprispeca.php';?>
