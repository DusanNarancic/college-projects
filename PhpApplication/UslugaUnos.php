						...
						if ($db_selected)
										   {
											...
											$SQL = "SELECT `".$bazapodataka."`.`Firma`.NazivFirme,`".$bazapodataka."`.`KorisnikUsluge`.IdFirme FROM `".$bazapodataka."`.`Firma` INNER JOIN `".$bazapodataka."`.`KorisnikUsluge` ON `".$bazapodataka."`.`KorisnikUsluge`.IdFirme=`".$bazapodataka."`.`Firma`.IdFirme WHERE `".$bazapodataka."`.`KorisnikUsluge`.IdKorisnika='".$idkorisnika."'";
											...
											$SQL3 = "SELECT `".$bazapodataka."`.`Ugovor`.IdUgovora,`".$bazapodataka."`.`KorisnikUsluge`.IdFirme FROM `".$bazapodataka."`.`Ugovor` INNER JOIN `".$bazapodataka."`.`KorisnikUsluge` ON `".$bazapodataka."`.`KorisnikUsluge`.IdFirme=`".$bazapodataka."`.`Ugovor`.IdFirme WHERE `".$bazapodataka."`.`KorisnikUsluge`.IdKorisnika='".$idkorisnika."'";
											//$SQL3="select distinct DatumSklapanjaUgovora from `".$bazapodataka."`.`Ugovor` ORDER BY DatumSklapanjaUgovora ASC";
...
<?php include 'delovi/desnouslugaunos.php';?>
</td>
