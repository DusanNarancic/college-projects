						...
						if ($db_selected)
										   {
											...
											//$SQL = "SELECT distinct IdFirme FROM `".$bazapodataka."`.Firma` ORDER BY IdFirme ASC";
											//$SQL = "SELECT  `".$bazapodataka."`.`Firma`.NazivFirme,`".$bazapodataka."`.`KorisnikUsluge`.IdFirme FROM `".$bazapodataka."`.`Firma` INNER JOIN `".$bazapodataka."`.`KorisnikUsluge` ON `".$bazapodataka."`.`KorisnikUsluge`.IdFirme=`".$bazapodataka."`.`Firma`.IdFirme";
...
<?php include 'delovi/desnokorisnikunos.php';?>
</td>
