...
<form ACTION="RacuniPretragaRezultatiDatumPrispeca.php" METHOD="POST" enctype="multipart/form-data">
...
<select name="datumPrispeca" required TABINDEX=8 width="250" style="width: 250px">		
	...
	if ($num_rows>0) {
							for ($row = 0; $row < $num_rows; $row++) {
								if ($row > $num_rows){
										...
										echo "<option value=\"$datumPrispeca\">$datumPrispeca</option>";
										} // if row
							} //for
