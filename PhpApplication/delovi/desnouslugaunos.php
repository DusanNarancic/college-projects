...
<td align="center">
<b><font face="Trebuchet MS" color="darkblue" size="3px">UNOS NOVE USLUGE</font></b></br>
</td>
<td style="width:3%;">
</td>
</tr>
...
<form ACTION="uslugasnimi.php" METHOD="POST">

<tr>
<td align="right" valign="top">
<b><font face="Trebuchet MS" color="darkblue" size="2px">Id ugovora:&nbsp;&nbsp;</font><br/></b>
</td>
<td align="left" valign="top">
<select name="idUgovora" required TABINDEX=9>		
	<option value="izaberite">izaberite...</option>
<?php
	if ($num_rows3>0) {
							for ($row = 0; $row < $num_rows3; $row++) {
								if ($row > $num_rows3){
										// nista
									} else {
										$IdUgovora=mysql_result($result3,$row,"IdUgovora");
										echo "<option value=\"$IdUgovora\">$IdUgovora</option>";
										} // if row
							} //for
...
<tr>
<td align="right" valign="top">
<b><font face="Trebuchet MS" color="darkblue" size="2px">Datum poslednje promene:&nbsp;&nbsp;</font><br/></b>
</td>
<td align="left" valign="top">
<input name="datumPoslednjePromene" type="date" size="60" required maxlength="250" VALUE="" TABINDEX=7/>
</td>
</tr>
...
<tr>
<td align="right" valign="top">     
<b><font face="Trebuchet MS" color="darkblue" size="2px">Datum poslednje promene:&nbsp;&nbsp;</font></b>
</td>
<td align="left" valign="top">
<input name="datumPoslednjePromene" type="date" size="5" required maxlength="2" VALUE="" TABINDEX=1/>
...
<tr>
<td align="right" valign="top">
<b><font face="Trebuchet MS" color="darkblue" size="2px">Stanje na računu:&nbsp;&nbsp;</font><br/></b>
</td>
<td align="left" valign="top">
<input name="stanje" type="number" size="52" required />
</td>
</tr>
