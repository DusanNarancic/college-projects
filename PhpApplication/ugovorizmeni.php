 <?php
	   ...
	   $datumSklapanjaUgovora=$_POST['datum'];
...
// *********************************************** PROVERA DA LI VEC POSTOJI korisnicko ime I SNIMANJE AKO NE POSTOJI
       if ($db_selected)
	    ...
	    mysql_query('SET NAMES "utf8"',$db_handle);
            ...
            if ($num_rowskorisnik>0) {
							$SQL = "UPDATE `".$bazapodataka."`.`Ugovor` SET DatumSklapanjaUgovora='".$datumSklapanjaUgovora."' WHERE IdUgovora=".$idugovora;
							/*echo $SQL;*/
	...
	header ('Location:ListaUgovora.php');	
