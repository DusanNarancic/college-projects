						...
						if ($db_selected)
										   {
											...
											//$SQLfirma = "SELECT `".$bazapodataka."`.`Firma`.NazivFirme,`".$bazapodataka."`.`Usluga`.IdFirme FROM `".$bazapodataka."`.`Firma` INNER JOIN `".$bazapodataka."`.`Usluga` ON `".$bazapodataka."`.`Usluga`.IdFirme=`".$bazapodataka."`.`Firma`.IdFirme WHERE `".$bazapodataka."`.`Usluga`.IdKorisnika='".$idkorisnika."'";
											$SQLfirma = "select distinct NazivFirme from `".$bazapodataka."`.`Firma` ORDER BY NazivFirme ASC";
											//$SQLfirma = "SELECT `".$bazapodataka."`.`Usluga`.IdUsluge,`".$bazapodataka."`.`Usluga`.IdKorisnika,`".$bazapodataka."`.`Firma`.IdFirme,`".$bazapodataka."`.`Firma`.NazivFirme FROM `".$bazapodataka."`.`Racun` INNER JOIN `".$bazapodataka."`.`Usluga` ON `".$bazapodataka."`.`Racun`.IdUsluge=`".$bazapodataka."`.`Usluga`.IdUsluge INNER JOIN `".$bazapodataka."`.`Firma` ON `".$bazapodataka."`.Usluga`.IdFirme=`".$bazapodataka."`.`Firma`.IdFirme WHERE `".$bazapodataka."`.`Usluga`.IdKorisnika='".$idkorisnika."'";
...
<?php include 'delovi/desnoracunipretragafirma.php';?>

<!-- densnoracunipretraga.php -->
</td>
