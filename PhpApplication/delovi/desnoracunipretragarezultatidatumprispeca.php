...
if ($db_selected)
										   {
											...
											$SQL = "SELECT `".$bazapodataka."`.`Usluga`.IdUsluge,`".$bazapodataka."`.`Usluga`.IdKorisnika,`".$bazapodataka."`.`Racun`.jePlacen,`".$bazapodataka."`.`Racun`.DatumKreiranjaRacuna,`".$bazapodataka."`.`Racun`.IznosZaUplatu,`".$bazapodataka."`.`Racun`.DatumRokaPlacanja,`".$bazapodataka."`.`Racun`.DatumUplate,`".$bazapodataka."`.`Racun`.DatumPrispeca FROM `".$bazapodataka."`.`Racun` INNER JOIN `".$bazapodataka."`.`Usluga` ON `".$bazapodataka."`.`Racun`.IdUsluge=`".$bazapodataka."`.`Usluga`.IdUsluge WHERE `".$bazapodataka."`.`Usluga`.IdKorisnika='".$idkorisnika."' and `".$bazapodataka."`.`Racun`.DatumPrispeca='".$datumPrispeca."' ";
											//$SQL = "select IdUsluge,DatumKreiranjaRacuna,IznosZaUplatu,DatumRokaPlacanja,DatumUplate,jePlacen,DatumPrispeca from `".$bazapodataka."`.`Racun` WHERE DatumPrispeca='".$datumPrispeca."'";
