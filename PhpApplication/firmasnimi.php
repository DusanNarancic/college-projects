       ...
       if ($db_selected)
	    ...
	    mysql_query('SET NAMES "utf8"',$db_handle);
            ...
            if ($num_rowskorisnik>0) {
							$SQL = "INSERT INTO `".$bazapodataka."`.`Firma` (NazivFirme, BrojRacunaFirme, BrojTelefonaFirme, AdresaFirme) VALUES ('$nazivfirme',$brojracuna,$brojtelefona,'$adresafirme')";
